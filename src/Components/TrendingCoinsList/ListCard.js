...
const ListCard = (props) => {
    ...
    return <>
        <div className="rounded-xl flex flex-col gap-y-6 shadow-xl bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 p-4 tracking-wider relative hover:scale-110 transition ease-in-out duration-300 hover:rotate-2">
